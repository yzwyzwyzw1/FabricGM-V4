...
func NewDefaultCredentials() credentials1.Bundle {
	c := &creds{
		newPerRPCCreds: func() credentials1.PerRPCCredentials {
...
//
// This API is experimental.
func NewComputeEngineCredentials() credentials1.Bundle {
	c := &creds{
		newPerRPCCreds: func() credentials1.PerRPCCredentials {
...
type creds struct {
	...
	transportCreds credentials1.TransportCredentials
	// The per RPC credentials associated with this bundle.
	perRPCCreds credentials1.PerRPCCredentials
	// Creates new per RPC credentials
	newPerRPCCreds func() credentials1.PerRPCCredentials
}

func (c *creds) TransportCredentials() credentials1.TransportCredentials {
	return c.transportCreds
}

func (c *creds) PerRPCCredentials() credentials1.PerRPCCredentials {
	if c == nil {
		return nil
	}
...
func (c *creds) NewWithMode(mode string) (credentials1.Bundle, error) {
	newCreds := &creds{
		mode:           mode,
	...
	case internal.CredsBundleModeFallback:
		newCreds.transportCreds = credentials1.NewTLS(nil)
