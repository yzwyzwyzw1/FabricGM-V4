...
import (
	...
	"errors"
	"fmt"
	"github.com/chinaso/fabricGM/cryptopkg/golangGM/grpc/credentials/alts/internal/handshaker"
	"github.com/chinaso/fabricGM/cryptopkg/golangGM/grpc/credentials/alts/internal/handshaker/service"
	"net"
	"sync"
	"time"

	core "github.com/chinaso/fabricGM/cryptopkg/golangGM/grpc/credentials/alts/internal"

	altspb "github.com/chinaso/fabricGM/cryptopkg/golangGM/grpc/credentials/alts/internal/proto/grpc_gcp"
...
type altsTC struct {
	info      *credentials1.ProtocolInfo
	side      core.Side
	accounts  []string
	hsAddress string
}
...
func NewClientCreds(opts *ClientOptions) credentials1.TransportCredentials {
...
func NewServerCreds(opts *ServerOptions) credentials1.TransportCredentials {
	return newALTS(core.ServerSide, nil, opts.HandshakerServiceAddress)
}

func newALTS(side core.Side, accounts []string, hsAddress string) credentials1.TransportCredentials {
	once.Do(func() {
...
func (g *altsTC) ClientHandshake(ctx context.Context, addr string, rawConn net.Conn) (_ net.Conn, _ credentials1.AuthInfo, err error) {
	if !vmOnGCP {
...
func (g *altsTC) ServerHandshake(rawConn net.Conn) (_ net.Conn, _ credentials1.AuthInfo, err error) {
	if !vmOnGCP {
		return nil, nil, ErrUntrustedPlatform
	}
	// Connecting to ALTS handshaker service.
...
func (g *altsTC) Info() credentials1.ProtocolInfo {
	return *g.info
}

func (g *altsTC) Clone() credentials1.TransportCredentials {
	info := *g.info
	var accounts []string
	if g.accounts != nil {
