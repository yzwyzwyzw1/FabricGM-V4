...
import (
	...
	"github.com/chinaso/fabricGM/cryptopkg/golangGM/grpc/credentials/alts/internal/authinfo"
	"github.com/chinaso/fabricGM/cryptopkg/golangGM/grpc/credentials/alts/internal/conn"
	altsgrpc "github.com/chinaso/fabricGM/cryptopkg/golangGM/grpc/credentials/alts/internal/proto/grpc_gcp"
...
func (h *altsHandshaker) ClientHandshake(ctx context.Context) (net.Conn, credentials1.AuthInfo, error) {
	if !acquire(1) {
...
func (h *altsHandshaker) ServerHandshake(ctx context.Context) (net.Conn, credentials1.AuthInfo, error) {
	if !acquire(1) {
		return nil, nil, errDropped
	}
	defer release(1)
