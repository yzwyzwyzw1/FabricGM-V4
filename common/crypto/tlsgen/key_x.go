...
// ------------------------------------------------------------------- //
func gmnewPrivKey() (*sm2.PrivateKey, []byte, error) {
...
func newCertKeyPair(isCA bool, isServer bool, host string, certSigner crypto.Signer, parent *x509.Certificate) (*CertKeyPair, error) {
	...
	case *sm2.PrivateKey:
		privateKey, privBytes, err := gmnewPrivKey()
		if err != nil {
			return nil, err
		}
	...
	default:
		return nil,errors.New("the type of certSigner is no found")
