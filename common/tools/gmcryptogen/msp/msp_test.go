...
import (
	...
	"github.com/chinaso/fabricGM/common/tools/gmcryptogen/ca"
	"github.com/chinaso/fabricGM/common/tools/gmcryptogen/msp"
	fabricmsp "github.com/chinaso/fabricGM/msp"
...
func TestGenerateLocalMSP(t *testing.T) {
	...
	fmt.Println("testMSPConfig",testMSPConfig)
