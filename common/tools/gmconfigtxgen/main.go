...
import (
	...
	"github.com/chinaso/fabricGM/common/tools/gmconfigtxgen/metadata"
...
var logger = flogging.MustGetLogger("common.tools.gmconfigtxgen")
...
func main() {
	...
	if channelID == "" && (outputBlock != "" || outputChannelCreateTx != "" || outputAnchorPeersUpdate != "") {
		...
		logger.Warningf("Omitting the channel ID for gmconfigtxgen for output operations is deprecated.  Explicitly passing the channel ID will be required in the future, defaulting to '%s'.", channelID)
	}
