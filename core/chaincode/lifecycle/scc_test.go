...
import (
	...
	"github.com/chinaso/fabricGM/core/chaincode/lifecycle/mock"
	"github.com/chinaso/fabricGM/core/chaincode/shim"
	lb "github.com/chinaso/fabricGM/protos/peer/lifecycle"
...
var _ = Describe("SCC", func() {
	...
	Describe("Path", func() {
		It("returns the path", func() {
			Expect(scc.Path()).To(Equal("github.com/chinaso/fabricGM/core/chaincode/lifecycle"))
		})
	})
