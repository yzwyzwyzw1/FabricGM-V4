...
import (
	...
	"github.com/chinaso/fabricGM/core/chaincode/platforms/util"
...
func (goPlatform *Platform) GetDeploymentPayload(path string) ([]byte, error) {
	...
	var provided = map[string]bool{
		"github.com/chinaso/fabricGM/core/chaincode/shim": true,
		"github.com/chinaso/fabricGM/protos/peer":         true,
	}
