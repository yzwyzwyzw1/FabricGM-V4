...
func Test_findSource(t *testing.T) {
	...
	source, err = findSource(gopath, "github.com/chinaso/fabricGM/peer")
	if err != nil {
...
func Test_DeploymentPayload(t *testing.T) {
	...
	payload, err := platform.GetDeploymentPayload("github.com/chinaso/fabricGM/examples/chaincode/go/example02/cmd")
...
func Test_DeploymentPayloadWithStateDBArtifacts(t *testing.T) {
	...
	payload, err := platform.GetDeploymentPayload("github.com/chinaso/fabricGM/examples/chaincode/go/marbles02")
	assert.NoError(t, err)
...
func TestValidatePath(t *testing.T) {
	...
	var tests = []struct {
		...
		{path: "github.com/chinaso/fabricGM/examples/chaincode/go/map", succ: true},
		{path: "github.com/chinaso/fabricGM/bad/chaincode/go/map", succ: false},
...
func TestGetDeploymentPayload(t *testing.T) {
	...
	var tests = []struct {
		...
		{gopath: defaultGopath, path: "github.com/chinaso/fabricGM/examples/chaincode/go/map", succ: true},
		{gopath: defaultGopath, path: "github.com/chinaso/fabricGM/examples/bad/go/map", succ: false},
...
func TestGenerateDockerBuild(t *testing.T) {
	...
	tests := []struct {
		...
		{gopath: defaultGopath, spec: spec{CCName: "map", Path: "github.com/chinaso/fabricGM/examples/chaincode/go/map", SuccessExpected: true, RealGen: true}},
		{gopath: defaultGopath, spec: spec{CCName: "mapBadPath", Path: "github.com/chinaso/fabricGM/examples/chaincode/go/map", File: "/src/github.com/hyperledger/fabric/examples/bad/path/to/map.go", Mode: 0100400, SuccessExpected: false}},
		{gopath: defaultGopath, spec: spec{CCName: "mapBadMode", Path: "github.com/chinaso/fabricGM/examples/chaincode/go/map", File: "/src/github.com/hyperledger/fabric/examples/chaincode/go/map/map.go", Mode: 0100555, SuccessExpected: false}},
