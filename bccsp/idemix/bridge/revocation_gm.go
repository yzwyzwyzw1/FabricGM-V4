...
//// GMRevocation encapsulates the idemix algorithms for revocation
//type GMRevocation struct {
//}
//
//// NewKey generate a new revocation key-pair.
//func (*GMRevocation) NewKey() (*sm2.PrivateKey, error) {
...
//func (*GMRevocation) Sign(key *sm2.PrivateKey, unrevokedHandles [][]byte, epoch int, alg bccsp.RevocationAlgorithm) (res []byte, err error) {
//	defer func() {
//		if r := recover(); r != nil {
//			res = nil
...
//func (*GMRevocation) Verify(pk *sm2.PublicKey, criRaw []byte, epoch int, alg bccsp.RevocationAlgorithm) (err error) {
//	defer func() {
//		if r := recover(); r != nil {
//			err = errors.Errorf("failure [%s]", r)
//		}
