...
func (fake *GMSignatureScheme) Sign(cred []byte, sk handlers.Big, Nym handlers.Ecp, RNym handlers.Big, ipk handlers.IssuerPublicKey, attributes []bccsp.IdemixAttribute, msg []byte, rhIndex int, cri []byte,hashType string) ([]byte, error) {
	var credCopy []byte
	if cred != nil {
...
func (fake *GMSignatureScheme) SignCallCount() int {
	fake.signMutex.RLock()
	defer fake.signMutex.RUnlock()
	return len(fake.signArgsForCall)
}

func (fake *GMSignatureScheme) SignArgsForCall(i int) ([]byte, handlers.Big, handlers.Ecp, handlers.Big, handlers.IssuerPublicKey, []bccsp.IdemixAttribute, []byte, int, []byte) {
	fake.signMutex.RLock()
	defer fake.signMutex.RUnlock()
...
func (fake *GMSignatureScheme) SignReturns(result1 []byte, result2 error) {
	fake.SignStub = nil
...
func (fake *GMSignatureScheme) SignReturnsOnCall(i int, result1 []byte, result2 error) {
	fake.SignStub = nil
...
func (fake *GMSignatureScheme) Verify(pk handlers.IssuerPublicKey, signature []byte, digest []byte, attributes []bccsp.IdemixAttribute, hIndex int, revocationPublicKeyType interface{}, epoch int) error {

	revocationPublicKey:=revocationPublicKeyType.(*sm2.PublicKey)
...
func (fake *GMSignatureScheme) VerifyCallCount() int {
	fake.verifyMutex.RLock()
	defer fake.verifyMutex.RUnlock()
	return len(fake.verifyArgsForCall)
}

func (fake *GMSignatureScheme) VerifyArgsForCall(i int) (handlers.IssuerPublicKey, []byte, []byte, []bccsp.IdemixAttribute, int, *sm2.PublicKey, int) {
	fake.verifyMutex.RLock()
	defer fake.verifyMutex.RUnlock()
...
func (fake *GMSignatureScheme) VerifyReturns(result1 error) {
	fake.VerifyStub = nil
...
func (fake *GMSignatureScheme) VerifyReturnsOnCall(i int, result1 error) {
	fake.VerifyStub = nil
...
func (fake *GMSignatureScheme) Invocations() map[string][][]interface{} {
...
func (fake *GMSignatureScheme) recordInvocation(key string, args []interface{}) {
...
var _ handlers.SignatureScheme = new(GMSignatureScheme)
