...
//func (fake *GMRevocation) NewKey() (*sm2.PrivateKey, error) {
func (fake *GMRevocation) NewKey(hashType string) (interface{}, error) {
...
func (fake *GMRevocation) NewKeyCallCount() int {
	fake.newKeyMutex.RLock()
	defer fake.newKeyMutex.RUnlock()
	return len(fake.newKeyArgsForCall)
}

func (fake *GMRevocation) NewKeyReturns(result1 *sm2.PrivateKey, result2 error) {
	fake.NewKeyStub = nil
...
func (fake *GMRevocation) NewKeyReturnsOnCall(i int, result1 *sm2.PrivateKey, result2 error) {
	fake.NewKeyStub = nil
...
//func (fake *GMRevocation) Sign(key *sm2.PrivateKey, unrevokedHandles [][]byte, epoch int, alg bccsp.RevocationAlgorithm) ([]byte, error) {
func (fake *GMRevocation) Sign(keyType interface{}, unrevokedHandles [][]byte, epoch int, alg bccsp.RevocationAlgorithm) ([]byte, error) {
...
func (fake *GMRevocation) SignCallCount() int {
	fake.signMutex.RLock()
	defer fake.signMutex.RUnlock()
	return len(fake.signArgsForCall)
}

func (fake *GMRevocation) SignArgsForCall(i int) (*sm2.PrivateKey, [][]byte, int, bccsp.RevocationAlgorithm) {
	fake.signMutex.RLock()
	defer fake.signMutex.RUnlock()
...
func (fake *GMRevocation) SignReturns(result1 []byte, result2 error) {
	fake.SignStub = nil
...
func (fake *GMRevocation) SignReturnsOnCall(i int, result1 []byte, result2 error) {
	fake.SignStub = nil
...
//func (fake *GMRevocation) Verify(pk *sm2.PublicKey, cri []byte, epoch int, alg bccsp.RevocationAlgorithm) error {
func (fake *GMRevocation) Verify(pkType interface{}, cri []byte, epoch int, alg bccsp.RevocationAlgorithm) error {
...
func (fake *GMRevocation) VerifyCallCount() int {
	fake.verifyMutex.RLock()
	defer fake.verifyMutex.RUnlock()
	return len(fake.verifyArgsForCall)
}

func (fake *GMRevocation) VerifyArgsForCall(i int) (*sm2.PublicKey, []byte, int, bccsp.RevocationAlgorithm) {
	fake.verifyMutex.RLock()
	defer fake.verifyMutex.RUnlock()
...
func (fake *GMRevocation) VerifyReturns(result1 error) {
	fake.VerifyStub = nil
...
func (fake *GMRevocation) VerifyReturnsOnCall(i int, result1 error) {
	fake.VerifyStub = nil
...
func (fake *GMRevocation) Invocations() map[string][][]interface{} {
...
func (fake *GMRevocation) recordInvocation(key string, args []interface{}) {
...
var _ handlers.Revocation = new(GMRevocation)
