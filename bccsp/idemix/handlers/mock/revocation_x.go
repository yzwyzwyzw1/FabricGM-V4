...
func (fake *Revocation) NewKey(hashType string) (interface{}, error) {
...
func (fake *Revocation) Sign(keyType interface{}, unrevokedHandles [][]byte, epoch int, alg bccsp.RevocationAlgorithm) ([]byte, error) {
...
func (fake *Revocation) Verify(pkType interface{}, cri []byte, epoch int, alg bccsp.RevocationAlgorithm) error {
