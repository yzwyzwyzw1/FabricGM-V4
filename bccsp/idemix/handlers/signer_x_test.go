...
var _ = Describe("Signature", func() {
	...
	Describe("when creating a signature", func() {
		...
		//	fakeSignatureSchemeGM *mock.GMSignatureScheme
		)

		BeforeEach(func() {

	//		SignatureSchemeTest:= "sm2Test"
			//if strings.Compare(SignatureSchemeTest,"sm2Test") == 0{
			//	fakeSignatureSchemeGM = &mock.GMSignatureScheme{}
			//	Signer = &handlers.Signer{SignatureScheme: fakeSignatureSchemeGM}
			//
			//}

			//if strings.Compare(SignatureSchemeTest,"ecdsaTest") == 0{
				fakeSignatureScheme = &mock.SignatureScheme{}  //次簽名方案只支持ecdsa
		...
		//	}
			...
			hashType := "sha256"
			nymSK, err = handlers.NewNymSecretKey(hashType,sk, nil, false)
	...
	//		nymSK               bccsp.Key
	//
	//		fakeSignatureScheme *mock.GMSignatureScheme
	//	)
	//
	//	BeforeEach(func() {
	//
	//		//if strings.Compare(SignatureSchemeTest,"ecdsaTest") == 0{
	//		fakeSignatureScheme = &mock.GMSignatureScheme{}  //次簽名方案只支持ecdsa
	//		Signer = &handlers.Signer{SignatureScheme: fakeSignatureScheme}
	//		//	}
	//
	//		var err error
	...
	//		})
	//
	//		fmt.Println("yzw",handlers.IsrevocationPublicKey(handlers.NewRevocationPublicKey(nil)))
	//
	//
	...
	//				[]byte("a digest"),
	//				&bccsp.IdemixSignerOpts{
	//					RevocationPublicKey: handlers.IsrevocationPublicKey(handlers.NewRevocationPublicKey(nil)),
	//				},
	//			)
	//
	//
